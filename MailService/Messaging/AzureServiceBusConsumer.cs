    ...
    public class AzureServiceBusConsumer : IAzureServiceBusConsumer
    {
        ...
        private async Task OnMakeOrder(ProcessMessageEventArgs args)
        {
            ...
            try
            {
                ...
                stringBuilder.Append("<p>Many more amazing art pieces to bid on and win!!</p>");
                ...
                await _emailService.sendEmail(user, stringBuilder.ToString(), "AuctionGarde order");
        ...
        private async Task OnRegisterUser(ProcessMessageEventArgs args)
        {
            ...
            try
            {
                ...
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.Append("<img src=\"https://cdn.pixabay.com/photo/2014/03/24/17/06/bird-295026_640.png\" width=\"1000\" height=\"600\">");
                stringBuilder.Append("<h1> Hello " + user.Name + "</h1>");
                stringBuilder.AppendLine("<br/>Welcome to AuctionGarde :)");

                stringBuilder.Append("<br/>");
                stringBuilder.Append('\n');
                stringBuilder.Append("<p>Beautiful arts of African women in one place. Start placing your bids!</p>");
                stringBuilder.Append("<p>Want to sell? Add to our beautiful collection ;).</p>");
